...
# 1️⃣ Define labels
LABELS = ["SEARCH_AVAILABILITY", "OTHER"]
label2id = {l:i for i,l in enumerate(LABELS)}
id2label = {i:l for l,i in label2id.items()}

directory_path = "./data/appt_availability_examples"
...
for file in csv_files:
    temp_df = pd.read_csv(f".//data//appt_availability_examples//{file}")
...
args = TrainingArguments(
    output_dir="./classifiers/appt_availability_model",
    save_strategy="epoch",
    learning_rate=2e-5,
...
trainer.train()
trainer.save_model("./classifiers/appt_availability_model")
tok.save_pretrained("./classifiers/appt_availability_model")